...
namespace GroceryBasket.API.Data.Migrations
{
    /// <inheritdoc />
    public partial class SeedingData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#d0f200", "FRT30", "Enjoy upto 30% off on all fruits", false, "Upto 30% off" },
                    ...
                    { 4, "#dad1f9", "FRT25", "Enjoy 25% off on all seasonal fruits", false, "25% OFF on Seasonal Fruits" }
                });
        }
